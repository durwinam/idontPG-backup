...
def ui_language_menu():
    return """<div class="language-picker"><button class="language-toggle" id="languageToggle" type="button" aria-label="تغییر زبان" title="زبان">🌐</button><div class="language-menu" id="languageMenu" hidden><button type="button" data-lang-choice="fa">🇮🇷 <span>فارسی</span></button><button type="button" data-lang-choice="en">🇬🇧 <span>English</span></button><button type="button" data-lang-choice="ru">🇷🇺 <span>Русский</span></button></div></div>"""
...
let current="fa"; try{current=localStorage.getItem(LANG_KEY)||"fa"}catch(e){}
