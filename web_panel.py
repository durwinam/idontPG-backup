...
def load_cfg():
    default = {
        ...
        "interval": "24", "node": False, "username": "admin", "password_hash": "", "password_salt": "", "last_login": {"time": 0, "ip": ""}
    }
...
/* v5.7.0: light theme icon polish — keep SVG icons readable and visually matched to the light glass UI. */
