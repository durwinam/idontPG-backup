...
def ui_language_script():
    return r"""(function(){
const LANG_KEY="idontpg-lang-v564";
const T={
...
Object.assign(T,{"کنترل کامل Backup":["کنترل کامل Backup","Backup Control Center","Центр управления бэкапом"],"کنترل Scheduler و اجرای Backup دستی.":["کنترل Scheduler و اجرای Backup دستی.","Manage the scheduler and run manual backups.","Управление планировщиком и ручной запуск бэкапа."],"Backup هفت روز اخیر":["Backup هفت روز اخیر","Backup — Last 7 Days","Бэкапы за 7 дней"],"Backup کنترل کامل":["Backup کنترل کامل","Backup Control Center","Центр управления бэкапом"],"Backup Settings":["تنظیمات Backup","Backup Settings","Настройки бэкапа"]});
