...
.neo-icon{position:relative;display:inline-grid;place-items:center;flex:0 0 44px;width:44px;height:44px;border-radius:15px;color:#8fdcff;background:linear-gradient(145deg,rgba(93,225,255,.10),rgba(124,58,237,.13));border:1px solid rgba(120,180,255,.18);box-shadow:inset 0 1px 0 rgba(255,255,255,.07),0 0 22px rgba(76,201,240,.06);transition:transform .25s ease,box-shadow .25s ease,color .25s ease,border-color .25s ease}
.neo-icon svg{width:22px;height:22px;fill:none;stroke:currentColor;stroke-width:1.75;stroke-linecap:round;stroke-linejoin:round;filter:drop-shadow(0 0 5px currentColor)}
...
.neo-icon.meta-icon{flex-basis:18px;width:18px;height:18px;border:0;background:transparent;box-shadow:none;border-radius:0;color:#9fb5d7}
...
.status-dot.status-off{background:#8a96ad;box-shadow:0 0 0 3px rgba(138,150,173,.08),0 0 10px rgba(138,150,173,.35);animation:none}
