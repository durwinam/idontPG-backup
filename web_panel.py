...
def ui_theme_css():
    ...
    return f':root{{--accent:{html.escape(p)};--accent2:{html.escape(a)};--glass:rgba(15,18,31,{op:.2f});--glass2:rgba(255,255,255,{min(.25,op*.12):.2f});--theme-radius:{radius}px;--theme-blur:{blur}px;--theme-font:{fs}px;--theme-glow:{glow};--theme-width:{int(t.get("content_width",1180))}px;--theme-gap:{int(t.get("card_gap",16))}px;--theme-shadow:{float(t.get("shadow_strength",.5))}}}body{{font-size:var(--theme-font)}}.container{{width:min(var(--theme-width),calc(100% - 34px))}}.grid{{gap:var(--theme-gap)}}.glass{{border-radius:var(--theme-radius)!important;backdrop-filter:blur(var(--theme-blur)) saturate(145%);-webkit-backdrop-filter:blur(var(--theme-blur)) saturate(145%)}}body{{background:{safe_bg or "var(--bg)"}!important}}.btn.primary{{box-shadow:0 10px 30px rgba(139,92,246,{glow:.2f})}}.card{{box-shadow:0 24px 70px rgba(0,0,0,var(--theme-shadow))}}body.light .card{{box-shadow:0 18px 55px rgba(109,40,217,calc(var(--theme-shadow) * .22))}}body.light .neo-icon{{color:#6d28d9!important;background:linear-gradient(145deg,rgba(255,255,255,.96),rgba(237,233,254,.78))!important;border-color:rgba(109,40,217,.20)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.98),0 8px 24px rgba(109,40,217,.12)!important}}body.light .neo-icon svg{{filter:drop-shadow(0 1px 2px rgba(109,40,217,.16))}}body.light .neo-icon.inline-icon,body.light .neo-icon.meta-icon{{background:transparent!important;border-color:transparent!important;box-shadow:none!important}}' 
