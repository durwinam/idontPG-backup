...
def status_dot(state="ok"):
    ...
    if state not in {"ok", "bad", "warn", "info", "off"}:
        state = "info"
    return f'<i class="status-dot status-{html.escape(state)}" aria-hidden="true"></i>'
...
.status-dot.status-ok{background:#42f5a5!important;box-shadow:0 0 4px 1px rgba(66,245,165,.95),0 0 10px 3px rgba(66,245,165,.72),0 0 22px 6px rgba(66,245,165,.38)!important;filter:drop-shadow(0 0 5px rgba(66,245,165,.95))}
.status-dot.status-info{background:#55d6ff!important;box-shadow:0 0 4px 1px rgba(85,214,255,.95),0 0 10px 3px rgba(85,214,255,.72),0 0 22px 6px rgba(85,214,255,.38)!important;filter:drop-shadow(0 0 5px rgba(85,214,255,.95))}
.status-dot.status-warn{background:#ffd84d!important;box-shadow:0 0 4px 1px rgba(255,216,77,.95),0 0 10px 3px rgba(255,216,77,.72),0 0 22px 6px rgba(255,216,77,.38)!important;filter:drop-shadow(0 0 5px rgba(255,216,77,.95))}
.status-dot.status-bad{background:#ff526f!important;box-shadow:0 0 4px 1px rgba(255,82,111,.95),0 0 10px 3px rgba(255,82,111,.72),0 0 22px 6px rgba(255,82,111,.38)!important;filter:drop-shadow(0 0 5px rgba(255,82,111,.95))}
.status-dot.status-off{background:#8b96ad!important;box-shadow:0 0 5px 1px rgba(139,150,173,.50),0 0 12px 3px rgba(139,150,173,.22)!important;filter:drop-shadow(0 0 4px rgba(139,150,173,.45));animation:none!important}
