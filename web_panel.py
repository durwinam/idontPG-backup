...
.status-dot{display:inline-block!important;position:relative!important;box-sizing:border-box!important;flex:0 0 10px!important;width:10px!important;min-width:10px!important;max-width:10px!important;height:10px!important;min-height:10px!important;max-height:10px!important;padding:0!important;margin:0!important;border:0!important;border-radius:50%!important;overflow:visible!important;vertical-align:middle!important;align-self:center!important;background:#43e6a0!important;opacity:1!important;transform:translateZ(0);will-change:transform,opacity,box-shadow;animation:statusPulse 1.35s ease-in-out infinite!important}.status-dot::after{content:"";position:absolute;inset:-2px;border-radius:50%;pointer-events:none;background:transparent;border:1px solid currentColor;opacity:0;transform:scale(.78);animation:statusRing 1.35s ease-out infinite;will-change:transform,opacity}.status-dot.status-ok{background:#43e6a0!important;color:#43e6a0!important;box-shadow:0 0 4px rgba(67,230,160,.70),0 0 8px rgba(67,230,160,.28),0 0 12px rgba(67,230,160,.10)!important}.status-dot.status-info{background:#58cfff!important;color:#58cfff!important;box-shadow:0 0 4px rgba(88,207,255,.70),0 0 8px rgba(88,207,255,.28),0 0 12px rgba(88,207,255,.10)!important}.status-dot.status-warn{background:#ffd45a!important;color:#ffd45a!important;box-shadow:0 0 4px rgba(255,212,90,.70),0 0 8px rgba(255,212,90,.28),0 0 12px rgba(255,212,90,.10)!important}.status-dot.status-bad{background:#ff526f!important;color:#ff526f!important;box-shadow:0 0 4px rgba(255,82,111,.70),0 0 8px rgba(255,82,111,.28),0 0 12px rgba(255,82,111,.10)!important}.status-dot.status-off{background:#8b96ad!important;color:#8b96ad!important;box-shadow:0 0 3px rgba(139,150,173,.28)!important;animation:none!important}.logo-fallback-text{display:none;font-weight:900;font-size:16px;letter-spacing:-.5px;color:#8fdcff;text-shadow:0 0 12px #6ee7ff}.logo-fallback .logo-fallback-text{display:block}.logo-fallback img{display:none!important}.panel-brand-icon{position:relative}.panel-brand-icon:after{display:none!important}.status.status-ok .status-dot{animation:statusPulse 1.35s ease-in-out infinite,statusGlowOk 1.35s ease-in-out infinite!important}.status.status-bad .status-dot{animation:statusPulse 1.35s ease-in-out infinite,statusGlowBad 1.35s ease-in-out infinite!important}.status.status-warn .status-dot{animation:statusPulse 1.35s ease-in-out infinite,statusGlowWarn 1.35s ease-in-out infinite!important}.status.status-info .status-dot{animation:statusPulse 1.35s ease-in-out infinite,statusGlowInfo 1.35s ease-in-out infinite!important}.status.status-ok{color:#8ff0c2;background:rgba(67,227,154,.075);border-color:rgba(67,227,154,.20)}.status.status-info{color:#9ed4ff;background:rgba(97,183,255,.075);border-color:rgba(97,183,255,.20)}.status.status-warn{color:#ffe58d;background:rgba(255,212,92,.075);border-color:rgba(255,212,92,.20)}.status.status-bad{color:#ff9aad;background:rgba(255,94,120,.075);border-color:rgba(255,94,120,.20)}.status.status-off{color:var(--muted);background:rgba(124,138,165,.055);border-color:var(--line)}
@keyframes statusPulse{0%,100%{opacity:.86;transform:translateZ(0) scale(.97)}50%{opacity:1;transform:translateZ(0) scale(1.05)}}
@keyframes statusRing{0%,100%{opacity:0;transform:scale(.78)}35%{opacity:.48;transform:scale(1.05)}65%{opacity:.12;transform:scale(1.24)}85%{opacity:0;transform:scale(1.32)}}
@keyframes statusGlowOk{0%,100%{box-shadow:0 0 3px rgba(67,230,160,.52),0 0 7px rgba(67,230,160,.18),0 0 11px rgba(67,230,160,.06)}50%{box-shadow:0 0 5px rgba(67,230,160,.92),0 0 10px rgba(67,230,160,.42),0 0 14px rgba(67,230,160,.14)}}
@keyframes statusGlowInfo{0%,100%{box-shadow:0 0 3px rgba(88,207,255,.52),0 0 7px rgba(88,207,255,.18),0 0 11px rgba(88,207,255,.06)}50%{box-shadow:0 0 5px rgba(88,207,255,.92),0 0 10px rgba(88,207,255,.42),0 0 14px rgba(88,207,255,.14)}}
@keyframes statusGlowWarn{0%,100%{box-shadow:0 0 3px rgba(255,212,90,.52),0 0 7px rgba(255,212,90,.18),0 0 11px rgba(255,212,90,.06)}50%{box-shadow:0 0 5px rgba(255,212,90,.92),0 0 10px rgba(255,212,90,.42),0 0 14px rgba(255,212,90,.14)}}
@keyframes statusGlowBad{0%,100%{box-shadow:0 0 3px rgba(255,82,111,.52),0 0 7px rgba(255,82,111,.18),0 0 11px rgba(255,82,111,.06)}50%{box-shadow:0 0 5px rgba(255,82,111,.92),0 0 10px rgba(255,82,111,.42),0 0 14px rgba(255,82,111,.14)}}
.status-dot.status-ok{animation:statusPulse 1.35s ease-in-out infinite,statusGlowOk 1.35s ease-in-out infinite!important}.status-dot.status-info{animation:statusPulse 1.35s ease-in-out infinite,statusGlowInfo 1.35s ease-in-out infinite!important}.status-dot.status-warn{animation:statusPulse 1.35s ease-in-out infinite,statusGlowWarn 1.35s ease-in-out infinite!important}.status-dot.status-bad{animation:statusPulse 1.35s ease-in-out infinite,statusGlowBad 1.35s ease-in-out infinite!important}.status-dot.status-off{animation:none!important}
