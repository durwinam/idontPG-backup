...
def ui_language_menu():
    return """<div class="language-picker"><button class="language-toggle" id="languageToggle" type="button" aria-label="Language" title="Language"><svg class="language-svg" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="8.5"></circle><path d="M3.8 12h16.4M12 3.5c2.2 2.4 3.3 5.2 3.3 8.5S14.2 18.1 12 20.5M12 3.5C9.8 5.9 8.7 8.7 8.7 12s1.1 6.1 3.3 8.5"></path></svg></button><div class="language-menu" id="languageMenu" hidden><button type="button" data-lang-choice="fa"><span>🇮🇷</span><span>فارسی</span></button><button type="button" data-lang-choice="en"><span>🇬🇧</span><span>English</span></button><button type="button" data-lang-choice="ru"><span>🇷🇺</span><span>Русский</span></button></div></div>"""
...
// Extended translations cover dashboard pages, notices, form labels, and dynamic messages.
Object.assign(maps.en,{
 "کنترل کامل Backup":"Full Backup Control","همه‌چیز برای مدیریت Backup، ارسال به Telegram و زمان‌بندی خودکار، داخل یک پنل شیشه‌ای و سریع.":"Everything for backup management, Telegram delivery and automatic scheduling in one fast glass panel.",
 ...
 "فایل Backup ساخته نشد.":"Backup file was not created.",
 "تقسیم فایل بزرگ برای Telegram در هسته Backup در دسترس نیست.":"Large-file splitting for Telegram is unavailable in the backup core.",
 "ارسال قسمت":"Part upload failed:","Backup در":"Backup sent in","قسمت ارسال شد.":"parts.",
 "Backup دستی ساخته شد":"Manual backup created","Backup ساخته شد":"Backup created","Backup و ارسال به Telegram موفق بود":"Backup and Telegram delivery succeeded","Backup ساخته شد ولی ارسال Telegram ناموفق بود":"Backup created, but Telegram delivery failed","Backup ناموفق بود":"Backup failed",
 "همین الان":"Just now","دقیقه پیش":"minutes ago","ساعت پیش":"hours ago","روز پیش":"days ago",
 "هنوز Backup ساخته نشده":"No backup has been created yet","قابل دریافت نیست":"Unavailable","به‌روزرسانی:":"Updated:","اکنون":"Now",
 "تغییر زبان":"Change language","زبان":"Language","فارسی":"Persian","لایت":"Light","دارک":"Dark","کاستوم":"Custom",
 "اطلاعات پنل":"Panel Information","Panel Information":"Panel Information","لینک پنل":"Panel link","وضعیت پنل":"Panel status","مصرف واقعی Node":"Real Node usage",
 "آنلاین":"Online","آفلاین":"Offline","فعال":"Active","متوقف":"Stopped","تنظیم شده":"Configured","تنظیم نشده":"Not configured","در حال اجرا":"Running","بدون Proxy":"No proxy","نامعتبر":"Invalid",
 "بازه":"Interval","ساعت":"hours","فضای دیسک":"Disk Space","استفاده‌شده":"Used","آزاد":"Free",
 "تنظیمات Telegram":"Telegram Settings","تنظیمات Backup":"Backup Settings","مدیریت Backup":"Manage Backup","Backup دستی":"Manual Backup","ارسال تست":"Send Test","ارسال تست پیام به Telegram":"Send Test Message to Telegram",
 "زمان‌بندی را روشن/خاموش کنید، Backup دستی بگیرید یا مشخص کنید PG-Node هم همراه Backup ذخیره شود.":"Enable or disable scheduling, run a manual backup, or include PG-Node with the backup.",
 "قبل از فعال‌کردن Scheduler اتصال را بررسی کنید.":"Check the connection before enabling the scheduler.","با Chat ID و Topic فعلی ارسال می‌شود.":"It will be sent using the current Chat ID and Topic.",
 "Backup بعدی":"Next Backup","زمان باقی‌مانده":"Time remaining","وضعیت Scheduler":"Scheduler status","وضعیت سرویس‌ها":"Service Status","منابع سرور مجازی":"Virtual Server Resources","CPU · RAM · Disk · پایش لحظه‌ای":"CPU · RAM · Disk · Live monitoring","وضعیت لحظه‌ای سرور":"Live Server Status","فعالیت‌های اخیر":"Recent Activity","آخرین فعالیت‌ها":"Recent Activity","هنوز فعالیتی ثبت نشده.":"No activity recorded yet.",
 "Backup هفت روز اخیر":"Backup — Last 7 Days","مدیریت Backupها":"Manage Backups","Backupهای موجود را مشاهده، دانلود یا حذف کنید.":"View, download, or delete available backups.","هنوز Backupای پیدا نشد.":"No backups found.",
 "تعداد Backup":"Backup count","حجم کل Backupها":"Total backup size","آخرین Backup":"Latest backup","تعداد فعالیت‌های اخیر":"Recent activity count",
 "حساب کاربری":"Account","نام کاربری و رمز ورود را مدیریت کنید.":"Manage your username and password.","نام کاربری":"Username","رمز عبور":"Password","رمز عبور جدید":"New password","تکرار رمز جدید":"Confirm new password","ذخیره تغییرات":"Save Changes","ذخیره تنظیمات":"Save Settings","ذخیره و شروع":"Save & Start","ساخت Backup جدید":"Create New Backup","شروع Backup دستی":"Run Manual Backup","توقف":"Stop","بازگشت":"Back","← داشبورد":"← Dashboard","← برگشت":"← Back",
 "بکاپ تلگرام":"Telegram Backup","اطلاعات ربات، مقصد، Topic، پروکسی و زمان‌بندی را تنظیم کنید؛ سپس Scheduler را شروع کنید.":"Configure the bot, destination, Topic, proxy and schedule, then start the Scheduler.","توکن BotFather را وارد کنید.":"Enter your BotFather token.","شماره Topic را وارد کنید؛ لینک Topic تلگرام هم قابل قبول است.":"Enter the Topic number; a Telegram Topic link is also accepted.","اختیاری. اگر Proxy ندارید خالی بگذارید.":"Optional. Leave empty if you do not use a proxy.",
 "زمان‌بندی خودکار":"Automatic Scheduler","بازه Backup (ساعت)":"Backup interval (hours)","شامل PG-Node شود":"Include PG-Node","همین حالا یک Backup کامل بگیرید.":"Create a full backup now.","یک پیام آزمایشی با تنظیمات فعلی ارسال می‌شود.":"A test message will be sent using the current settings.",
 "تست تلگرام":"Telegram Test","یک پیام آزمایشی با تنظیمات فعلی ارسال می‌شود.":"A test message will be sent using the current settings.","Proxy":"Proxy",
 "فضای دیسک":"Disk Space","Backup Activity":"Backup Activity","Disk Monitor":"Disk Monitor","Health Check":"Health Check","Recent Activity":"Recent Activity","Next Scheduled Backup":"Next Scheduled Backup",
 "پیام تست با موفقیت ارسال شد.":"Test message sent successfully.","ارسال پیام تست ناموفق بود.":"Test message failed.","Scheduler ذخیره و شروع شد.":"Scheduler saved and started.","Scheduler ذخیره شد ولی شروع آن با خطا مواجه شد.":"Scheduler saved, but starting it failed.","تنظیمات عمومی ذخیره شد.":"General settings saved.","تنظیمات Telegram با موفقیت ذخیره شد.":"Telegram settings saved successfully.","تنظیمات حساب با موفقیت ذخیره شد.":"Account settings saved successfully.","تنظیمات با موفقیت ذخیره شد و روی کل وب‌پنل اعمال شد.":"Settings saved and applied across the web panel.",
 "صفحه پیدا نشد.":"Page not found.","درخواست نامعتبر است.":"Invalid request.","درخواست نامعتبر یا منقضی شده است. صفحه را دوباره باز کنید.":"Invalid or expired request. Reload the page and try again.","تلاش دوباره":"Try Again","بازگشت به مدیریت":"Back to Admin","بازگشت به Telegram":"Back to Telegram",
 "مدیریت خصوصی":"Private Administration","این بخش فقط برای مدیر اصلی است.":"This area is for the main administrator only.","ورود به پنل":"Panel Login","برای ورود، نام کاربری و رمز عبور ادمین را وارد کنید.":"Enter the admin username and password to continue.","ورود امن":"Secure Login","راه‌اندازی اولیه":"Initial Setup","ساخت رمز و ورود":"Create Password & Login","رمز مدیر":"Admin Password","تکرار رمز":"Confirm Password","تغییر رمز":"Change Password","ورود به مدیریت":"Enter Administration","ساخت حساب و ورود":"Create Account & Login",
 "مرکز مدیریت":"Control Center","شخصی‌سازی کامل ظاهر، داشبورد و اجزای وب‌پنل.":"Customize the complete look, dashboard and web-panel components.","شخصی‌سازی":"Customization","شش تم آماده":"Six Ready Themes","کاربر عادی هیچ گزینه‌ای برای انتخاب تم نمی‌بیند.":"Regular users cannot choose a theme.","ظاهر":"Appearance","رنگ اصلی":"Primary color","رنگ دوم":"Secondary color","پس‌زمینه":"Background","شفافیت Glass":"Glass opacity","Blur":"Blur","گردی کارت":"Card radius","شدت Glow":"Glow intensity","Glow و حرکت":"Glow & Motion","سرعت انیمیشن":"Animation speed","اندازه فونت":"Font size","عرض Logo":"Logo width","Logo URL":"Logo URL","متن و برند":"Text & Branding","نام پنل":"Panel name","عنوان داشبورد":"Dashboard title","عنوان بکاپ":"Backup title","عنوان حجم مصرفی":"Traffic title","عنوان مصرف":"Traffic title","عنوان فعالیت‌های اخیر":"Recent activity title","عنوان فعالیت":"Activity title","توضیح داشبورد":"Dashboard description","چیدمان و تجربه کاربر":"Layout & User Experience","عرض محتوای داشبورد":"Dashboard content width","فاصله بین کارت‌ها":"Card spacing","شدت سایه کارت":"Card shadow strength","عنوان کوچک زیر برند":"Brand subtitle","بخش‌های داشبورد":"Dashboard sections","حجم مصرفی":"Traffic usage","آمار سرور":"Server statistics","دکمه سفارشی":"Custom Button","دکمه‌های سفارشی":"Custom Buttons","نام":"Name","آیکون":"Icon","لینک":"Link","افزودن":"Add","حذف":"Delete","ذخیره همه تغییرات":"Save All Changes",
 "نام کاربری ادمین":"Admin username","رمز ادمین":"Admin password","تلاش زیاد؛ ۱۵ دقیقه دیگر دوباره امتحان کنید.":"Too many attempts; try again in 15 minutes.","نام کاربری یا رمز عبور اشتباه است.":"Invalid username or password.","نام کاربری یا رمز ادمین اشتباه است.":"Invalid admin username or password.","رمز باید حداقل ۸ کاراکتر، شامل حداقل ۲ حرف، ۱ عدد و یکی از # @ * باشد.":"Password must be at least 8 characters and include at least 2 letters, 1 number, and one of # @ *.","تکرار رمز عبور با رمز جدید یکسان نیست.":"Password confirmation does not match the new password.","رمز جدید باید حداقل ۸ کاراکتر، شامل حروف انگلیسی، حداقل یک حرف بزرگ، یک عدد و یک کاراکتر ویژه باشد.":"New password must be at least 8 characters and include English letters, one uppercase letter, one number, and one special character.","تکرار رمز جدید با رمز عبور یکسان نیست.":"New password confirmation does not match the password.",
 "نمایش بخش‌ها":"Show sections","داشبورد":"Dashboard","نمای کلی سیستم":"System overview","منوی اصلی":"Main menu","باز کردن منو":"Open menu","منو":"Menu","بستن منو":"Close menu","انتخاب تم":"Choose theme","خروج":"Logout","پایان نشست":"End session"
});
Object.assign(maps.ru,{
 "کنترل کامل Backup":"Полное управление бэкапами","همه‌چیز برای مدیریت Backup، ارسال به Telegram و زمان‌بندی خودکار، داخل یک پنل شیشه‌ای و سریع.":"Всё для управления бэкапами, отправки в Telegram и автоматического планировщика в одной быстрой стеклянной панели.",
 "Bot Token و Chat ID الزامی هستند.":"Требуются Bot Token и Chat ID.","Topic ID نامعتبر است. فقط عدد message_thread_id یا لینک Topic تلگرام را وارد کنید.":"Недействительный Topic ID. Введите номер message_thread_id или ссылку на тему Telegram.","فایل Backup ساخته نشد.":"Файл бэкапа не создан.","Backup دستی ساخته شد":"Ручной бэкап создан","Backup ساخته شد":"Бэкап создан","Backup و ارسال به Telegram موفق بود":"Бэкап и отправка в Telegram выполнены успешно","Backup ساخته شد ولی ارسال Telegram ناموفق بود":"Бэкап создан, но отправка в Telegram не удалась","Backup ناموفق بود":"Бэкап не выполнен",
 "اطلاعات پنل":"Информация о панели","لینک پنل":"Ссылка панели","وضعیت پنل":"Статус панели","مصرف واقعی Node":"Реальный трафик Node","آنلاین":"Онлайн","آفلاین":"Офлайн","فعال":"Активно","متوقف":"Остановлено","تنظیم شده":"Настроено","تنظیم نشده":"Не настроено","در حال اجرا":"Работает","بدون Proxy":"Без прокси","نامعتبر":"Недействительно","بازه":"Интервал","ساعت":"часов","استفاده‌شده":"Использовано","آزاد":"Свободно",
 "زمان‌بندی را روشن/خاموش کنید، Backup دستی بگیرید یا مشخص کنید PG-Node هم همراه Backup ذخیره شود.":"Включайте или отключайте планировщик, запускайте ручной бэкап или добавляйте PG-Node в бэкап.","با Chat ID و Topic فعلی ارسال می‌شود.":"Будет отправлено с текущими Chat ID и Topic.","زمان باقی‌مانده":"Оставшееся время","وضعیت Scheduler":"Состояние планировщика","هنوز فعالیتی ثبت نشده.":"Действий пока нет.","فضای دیسک":"Дисковое пространство","استفاده‌شده":"Использовано","آزاد":"Свободно",
 "تغییر زبان":"Сменить язык","زبان":"Язык","فارسی":"Персидский","اطلاعات ربات، مقصد، Topic، پروکسی و زمان‌بندی را تنظیم کنید؛ سپس Scheduler را شروع کنید.":"Настройте бота, назначение, Topic, прокси и расписание, затем запустите планировщик.","توکن BotFather را وارد کنید.":"Введите токен BotFather.","شماره Topic را وارد کنید؛ لینک Topic تلگرام هم قابل قبول است.":"Введите номер Topic; также принимается ссылка на тему Telegram.","اختیاری. اگر Proxy ندارید خالی بگذارید.":"Необязательно. Оставьте пустым, если прокси не используется.",
 "زمان‌بندی خودکار":"Автоматический планировщик","بازه Backup (ساعت)":"Интервал бэкапа (часы)","شامل PG-Node شود":"Включить PG-Node","همین حالا یک Backup کامل بگیرید.":"Создайте полный бэкап прямо сейчас.","یک پیام آزمایشی با تنظیمات فعلی ارسال می‌شود.":"Будет отправлено тестовое сообщение с текущими настройками.","صفحه پیدا نشد.":"Страница не найдена.","درخواست نامعتبر است.":"Недействительный запрос.","تلاش دوباره":"Повторить","بازگشت":"Назад","← داشبورد":"← Панель","← برگشت":"← Назад",
 "ذخیره تغییرات":"Сохранить изменения","ذخیره تنظیمات":"Сохранить настройки","ذخیره و شروع":"Сохранить и запустить","ذخیره همه تغییرات":"Сохранить все изменения","شروع Backup دستی":"Запустить ручной бэкап","ساخت Backup جدید":"Создать новый бэкап","ارسال تست":"Тестовая отправка","ارسال تست پیام به Telegram":"Отправить тестовое сообщение в Telegram","قبل از فعال‌کردن Scheduler اتصال را بررسی کنید.":"Проверьте подключение перед запуском планировщика.",
 "حساب کاربری":"Аккаунт","نام کاربری و رمز ورود را مدیریت کنید.":"Управляйте именем пользователя и паролем.","نام کاربری":"Имя пользователя","رمز عبور":"Пароль","رمز عبور جدید":"Новый пароль","تکرار رمز جدید":"Повтор нового пароля","نام کاربری ادمین":"Имя администратора","رمز ادمین":"Пароль администратора","ورود به مدیریت":"Войти в администрирование","ساخت حساب و ورود":"Создать аккаунт и войти","تلاش زیاد؛ ۱۵ دقیقه دیگر دوباره امتحان کنید.":"Слишком много попыток; повторите через 15 минут.","نام کاربری یا رمز عبور اشتباه است.":"Неверное имя пользователя или пароль.","نام کاربری یا رمز ادمین اشتباه است.":"Неверные данные администратора.",
 "مرکز مدیریت":"Центр управления","شخصی‌سازی کامل ظاهر، داشبورد و اجزای وب‌پنل.":"Полная настройка внешнего вида, панели и компонентов.","شخصی‌سازی":"Настройка","شش تم آماده":"Шесть готовых тем","کاربر عادی هیچ گزینه‌ای برای انتخاب تم نمی‌بیند.":"Обычные пользователи не видят выбор темы.","ظاهر":"Внешний вид","رنگ اصلی":"Основной цвет","رنگ دوم":"Вторичный цвет","پس‌زمینه":"Фон","شفافیت Glass":"Прозрачность Glass","گردی کارت":"Скругление карточек","شدت Glow":"Интенсивность свечения","Glow و حرکت":"Свечение и анимация","سرعت انیمیشن":"Скорость анимации","اندازه فونت":"Размер шрифта","عرض Logo":"Ширина логотипа","متن و برند":"Текст и бренд","نام پنل":"Название панели","عنوان داشبورد":"Заголовок панели","عنوان بکاپ":"Заголовок бэкапа","عنوان حجم مصرفی":"Заголовок трафика","عنوان مصرف":"Заголовок трафика","عنوان فعالیت‌های اخیر":"Заголовок последних действий","عنوان فعالیت":"Заголовок действий","توضیح داشبورد":"Описание панели","چیدمان و تجربه کاربر":"Макет и UX","عرض محتوای داشبورد":"Ширина содержимого","فاصله بین کارت‌ها":"Расстояние между карточками","شدت سایه کارت":"Интенсивность тени","عنوان کوچک زیر برند":"Подзаголовок бренда","بخش‌های داشبورد":"Разделы панели","حجم مصرفی":"Использование трафика","آمار سرور":"Статистика сервера","دکمه سفارشی":"Пользовательская кнопка","دکمه‌های سفارشی":"Пользовательские кнопки","نام":"Название","آیکون":"Иконка","لینک":"Ссылка","افزودن":"Добавить","حذف":"Удалить","کاستوم":"Пользовательская","لایت":"Светлая","دارک":"Тёмная",
 "پیام تست با موفقیت ارسال شد.":"Тестовое сообщение отправлено.","ارسال پیام تست ناموفق بود.":"Не удалось отправить тестовое сообщение.","Scheduler ذخیره و شروع شد.":"Планировщик сохранён и запущен.","Scheduler ذخیره شد ولی شروع آن با خطا مواجه شد.":"Планировщик сохранён, но запуск завершился ошибкой.","تنظیمات عمومی ذخیره شد.":"Общие настройки сохранены.","تنظیمات Telegram با موفقیت ذخیره شد.":"Настройки Telegram сохранены.","تنظیمات حساب با موفقیت ذخیره شد.":"Настройки аккаунта сохранены.","تنظیمات با موفقیت ذخیره شد و روی کل وب‌پنل اعمال شد.":"Настройки сохранены и применены ко всей панели.",
 "نمایش بخش‌ها":"Показывать разделы","داشبورد":"Панель","نمای کلی سیستم":"Обзор системы","منوی اصلی":"Главное меню","باز کردن منو":"Открыть меню","منو":"Меню","بستن منو":"Закрыть меню","انتخاب تم":"Выбрать тему","خروج":"Выйти","پایان نشست":"Завершить сеанс"
});
function setLanguage(lang){
  ...
  const btn=document.getElementById("languageToggle"); if(btn){const labels={fa:"تغییر زبان",en:"Change language",ru:"Сменить язык"};btn.title=labels[lang];btn.setAttribute("aria-label",labels[lang]);}
  translateDynamicText(lang);
...
function translateDynamicText(lang){
  ...
  document.querySelectorAll("body *:not(script):not(style)").forEach(el=>{
    ...
    const raw=(el.dataset.i18nOriginal||el.textContent).trim(); if(!raw) return;
    el.dataset.i18nOriginal=raw;
    if(Object.prototype.hasOwnProperty.call(dict,raw)){el.textContent=dict[raw];return;}
    let out=raw;
    Object.keys(dict).sort((a,b)=>b.length-a.length).forEach(k=>{if(k.length>2&&out.includes(k)) out=out.split(k).join(dict[k]);});
    if(out!==raw) el.textContent=out;
  });
  document.querySelectorAll("input[placeholder],textarea[placeholder]").forEach(el=>{
    const raw=el.dataset.i18nPlaceholder||el.getAttribute("placeholder"); if(!raw)return;
    el.dataset.i18nPlaceholder=raw;
    if(dict[raw]) el.setAttribute("placeholder",dict[raw]);
  });
  document.querySelectorAll("[title]").forEach(el=>{
    const raw=el.dataset.i18nTitle||el.getAttribute("title"); if(!raw)return;
    el.dataset.i18nTitle=raw;
    if(dict[raw]) el.setAttribute("title",dict[raw]);
  });
}
