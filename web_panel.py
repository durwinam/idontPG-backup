...
body.light{--bg:#fff7fc;--text:#26162d;--muted:#735c78;--line:rgba(124,58,237,.18);--glass:rgba(255,255,255,.60);--glass2:rgba(255,255,255,.48);--accent:#7c3aed;--accent2:#db2777;--shadow:0 24px 70px rgba(124,58,237,.16)}
*{box-sizing:border-box}html{min-height:100%;background:var(--bg)}body{margin:0;min-height:100vh;color:var(--text);font-family:"Vazirmatn","Tahoma","Segoe UI",sans-serif;overflow-x:hidden;background:radial-gradient(circle at 15% 15%,rgba(139,92,246,.18),transparent 30%),radial-gradient(circle at 85% 10%,rgba(34,211,238,.14),transparent 28%),radial-gradient(circle at 70% 90%,rgba(236,72,153,.12),transparent 32%),#06070d;transition:background .45s ease,color .35s ease}
...
<article class="glass card"><div class="card-head"><div style="display:flex;gap:12px"><div class="icon">🌐</div><div><h3 class="title">اطلاعات پنل</h3><p class="sub">Panel Information</p></div><span class="status {panel_status_class}">{'● آنلاین' if panel_info['status'] == 'Online' else '○ آفلاین'}</span></div>
