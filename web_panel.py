...
.status-dot{display:inline-block!important;position:relative!important;width:8px!important;height:8px!important;min-width:8px!important;max-width:8px!important;min-height:8px!important;max-height:8px!important;flex:0 0 8px!important;flex-grow:0!important;flex-shrink:0!important;padding:0!important;margin:0!important;border-radius:50%!important;background:#7c8aa5!important;box-shadow:0 0 0 3px rgba(124,138,165,.08),0 0 10px rgba(124,138,165,.35);animation:statusPulse 1.8s ease-in-out infinite;vertical-align:middle;align-self:center;overflow:visible!important}
...
.meta-row > .status-dot,.meta-row span:first-child > .status-dot{flex:0 0 8px!important;width:8px!important;max-width:8px!important;min-width:8px!important;height:8px!important;max-height:8px!important;min-height:8px!important}
