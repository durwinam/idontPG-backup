...
.status-dot{
 ...
 background:#34f5a0!important;
 box-shadow:0 0 0 2px rgba(52,245,160,.10),0 0 8px rgba(52,245,160,.65),0 0 18px rgba(52,245,160,.35)!important;
 animation:statusPulse 1.8s ease-in-out infinite!important;
}
.status-dot.status-ok{background:#34f5a0!important;box-shadow:0 0 0 2px rgba(52,245,160,.10),0 0 8px rgba(52,245,160,.72),0 0 18px rgba(52,245,160,.38)!important}
.status-dot.status-info{background:#55c8ff!important;box-shadow:0 0 0 2px rgba(85,200,255,.10),0 0 8px rgba(85,200,255,.72),0 0 18px rgba(85,200,255,.38)!important}
.status-dot.status-warn{background:#ffd34f!important;box-shadow:0 0 0 2px rgba(255,211,79,.10),0 0 8px rgba(255,211,79,.72),0 0 18px rgba(255,211,79,.38)!important}
.status-dot.status-bad{background:#ff4f70!important;box-shadow:0 0 0 2px rgba(255,79,112,.10),0 0 8px rgba(255,79,112,.75),0 0 18px rgba(255,79,112,.40)!important}
.status-dot.status-off{background:#8792aa!important;box-shadow:0 0 0 2px rgba(135,146,170,.08),0 0 8px rgba(135,146,170,.30)!important;animation:none!important}
...
.meta-row > .status-dot,.meta-label > .status-dot{
 flex:0 0 9px!important;width:9px!important;max-width:9px!important;min-width:9px!important;
 height:9px!important;max-height:9px!important;min-height:9px!important;
...
<article class="glass card"><div class="card-head"><div style="display:flex;gap:12px">{ui_icon("health", "card-icon")}<div><h3 class="title">Health Check</h3><p class="sub">وضعیت سرویس‌ها</p></div></div></div><div class="health-list">{''.join(f'<div class="meta-row"><span class="meta-label">{status_dot("ok" if ok else "bad")} {html.escape(name)}</span><strong>{html.escape(detail)}</strong></div>' for name,ok,detail in get_health_info(c,panel_info))}</div></article>
