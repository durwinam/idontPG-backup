...
.logo-fallback-text{display:none;font-weight:900;font-size:16px;letter-spacing:-.5px;color:#8fdcff;text-shadow:0 0 12px #6ee7ff}.logo-fallback .logo-fallback-text{display:block}.logo-fallback img{display:none!important}.panel-brand-icon{position:relative}.panel-brand-icon:after{display:none!important}.status.status-ok .status-dot,.status.status-bad .status-dot,.status.status-warn .status-dot{animation:statusGlow 2.6s ease-in-out infinite}
...
@keyframes statusGlow{0%,100%{opacity:.82}50%{opacity:1}}
