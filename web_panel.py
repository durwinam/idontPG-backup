...
.language-picker{position:relative}.language-svg{width:21px;height:21px;display:block;fill:none;stroke:currentColor;stroke-width:1.7;stroke-linecap:round;stroke-linejoin:round;filter:drop-shadow(0 0 4px currentColor) drop-shadow(0 0 10px color-mix(in srgb,currentColor 55%,transparent));transition:filter .22s ease,transform .22s ease}.lang-code{font-size:10px;font-weight:900;letter-spacing:.4px}.language-toggle{min-width:46px;width:46px;height:42px;padding:0;border:1px solid var(--line);border-radius:14px;color:var(--text);background:var(--glass2);backdrop-filter:blur(18px);cursor:pointer;font-size:18px;transition:.25s ease}.language-toggle:hover{transform:translateY(-2px);border-color:rgba(34,211,238,.55);box-shadow:0 10px 30px rgba(34,211,238,.22)}.language-toggle:hover .language-svg{filter:drop-shadow(0 0 5px currentColor) drop-shadow(0 0 14px color-mix(in srgb,currentColor 70%,transparent));transform:scale(1.06)}.language-toggle:active{transform:scale(.96)}.language-menu{position:absolute;top:50px;right:0;z-index:131;min-width:155px;padding:7px;border:1px solid var(--line);border-radius:16px;background:rgba(12,14,24,.94);backdrop-filter:blur(22px) saturate(150%);-webkit-backdrop-filter:blur(22px) saturate(150%);box-shadow:0 18px 50px rgba(0,0,0,.35)}.language-menu[hidden]{display:none}.language-menu button{width:100%;display:flex;align-items:center;gap:9px;padding:10px 11px;border:0;border-radius:11px;background:transparent;color:var(--text);cursor:pointer;font:inherit;text-align:right}.language-menu button:hover,.language-menu button.active{background:rgba(124,58,237,.12)}body.light .language-menu{background:rgba(255,255,255,.96);border-color:rgba(124,58,237,.18);box-shadow:0 18px 50px rgba(124,58,237,.18)}body.light .language-menu button{color:#26162d}body.light .language-menu button:hover,body.light .language-menu button.active{background:rgba(124,58,237,.08)}
...
body.light .card-icon,body.light .hero-icon{filter:none}body.light .neo-icon{background:transparent!important;border-color:transparent!important;box-shadow:none!important}body.light .neo-icon svg{filter:drop-shadow(0 0 4px currentColor) drop-shadow(0 0 10px color-mix(in srgb,currentColor 55%,transparent));transition:filter .22s ease,transform .22s ease}
...
def ui_language_menu():
    return """<div class="language-picker"><button class="language-toggle" id="languageToggle" type="button" aria-label="Language" title="Language"><svg class="language-svg" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M3 12h18M12 3c2.6 2.5 4 5.5 4 9s-1.4 6.5-4 9c-2.6-2.5-4-6.5-4-9s1.4-6.5 4-9Z"/></svg></button><div class="language-menu" id="languageMenu" hidden><button type="button" data-lang-choice="fa"><span class="lang-code">فا</span><span>فارسی</span></button><button type="button" data-lang-choice="en"><span class="lang-code">EN</span><span>English</span></button><button type="button" data-lang-choice="ru"><span class="lang-code">РУ</span><span>Русский</span></button></div></div>"""
...
const T={
"داشبورد":["داشبورد","Dashboard","Панель"],"نمای کلی سیستم":["نمای کلی سیستم","System overview","Обзор системы"],"بکاپ تلگرام":["بکاپ تلگرام","Telegram Backup","Резервная копия Telegram"],"تنظیمات و ارسال":["تنظیمات و ارسال","Settings & delivery","Настройки и отправка"],"تنظیمات بکاپ":["تنظیمات بکاپ","Backup Settings","Настройки бэкапа"],"Scheduler و Backup":["Scheduler و Backup","Scheduler & Backup","Планировщик и бэкап"],"تست تلگرام":["تست تلگرام","Telegram Test","Тест Telegram"],"بررسی اتصال":["بررسی اتصال","Connection check","Проверка подключения"],"حساب کاربری":["حساب کاربری","Account","Аккаунт"],"مدیریت ورود":["مدیریت ورود","Login management","Управление входом"],"خروج":["خروج","Logout","Выйти"],"پایان نشست":["پایان نشست","End session","Завершить сеанс"],"منوی اصلی":["منوی اصلی","Main menu","Главное меню"],"منو":["منو","Menu","Меню"],
"اطلاعات Backup":["اطلاعات Backup","Backup Information","Информация о бэкапе"],"اطلاعات بکاپ":["اطلاعات بکاپ","Backup Information","Информация о бэкапе"],"تعداد Backup":["تعداد Backup","Backup count","Количество бэкапов"],"حجم کل Backupها":["حجم کل Backupها","Total backup size","Общий размер бэкапов"],"آخرین Backup":["آخرین Backup","Latest backup","Последний бэкап"],"هنوز Backup ساخته نشده":["هنوز Backup ساخته نشده","No backup created yet","Бэкапы ещё не созданы"],"هنوز Backupای پیدا نشد.":["هنوز Backupای پیدا نشد.","No backups found.","Бэкапы не найдены."],"قابل دریافت نیست":["قابل دریافت نیست","Unavailable","Недоступно"],"لینک پنل":["لینک پنل","Panel link","Ссылка панели"],"وضعیت پنل":["وضعیت پنل","Panel status","Статус панели"],"مصرف واقعی Node":["مصرف واقعی Node","Real Node usage","Реальный трафик Node"],"دریافت مستقیم از PasarGuard Node":["دریافت مستقیم از PasarGuard Node","Directly from PasarGuard Node","Напрямую из PasarGuard Node"],"تنظیم شده":["تنظیم شده","Configured","Настроено"],"تنظیم نشده":["تنظیم نشده","Not configured","Не настроено"],"در حال اجرا":["در حال اجرا","Running","Работает"],"فعال":["فعال","Active","Активно"],"غیرفعال":["غیرفعال","Inactive","Неактивно"],"متوقف":["متوقف","Stopped","Остановлено"],"آنلاین":["آنلاین","Online","Онлайн"],"آفلاین":["آفلاین","Offline","Офлайн"],"نامعتبر":["نامعتبر","Invalid","Недействительно"],"هشدار":["هشدار","Warning","Предупреждение"],"اطلاعات":["اطلاعات","Info","Информация"],
"Bot Token":["توکن ربات","Bot Token","Токен бота"],"Chat ID":["شناسه چت","Chat ID","ID чата"],"Topic ID":["شناسه تاپیک","Topic ID","ID темы"],"Proxy":["پروکسی","Proxy","Прокси"],"بدون Proxy":["بدون Proxy","No Proxy","Без прокси"],"تنظیمات Telegram":["تنظیمات Telegram","Telegram Settings","Настройки Telegram"],"ارسال تست":["ارسال تست","Send Test","Тестовая отправка"],"ارسال پیام تست":["ارسال پیام تست","Send Test Message","Отправить тестовое сообщение"],"ارسال تست پیام به Telegram":["ارسال تست پیام به Telegram","Send a Test Message to Telegram","Отправить тестовое сообщение в Telegram"],"قبل از فعال‌کردن Scheduler اتصال را بررسی کنید.":["قبل از فعال‌کردن Scheduler اتصال را بررسی کنید.","Check the connection before enabling the scheduler.","Проверьте подключение перед включением планировщика."],
"تنظیمات Backup":["تنظیمات Backup","Backup Settings","Настройки бэкапа"],"مدیریت Backup":["مدیریت Backup","Manage Backup","Управление бэкапом"],"شروع Backup دستی":["شروع Backup دستی","Run Manual Backup","Запустить бэкап вручную"],"بکاپ دستی":["بکاپ دستی","Manual Backup","Ручной бэкап"],"زمان‌بندی خودکار":["زمان‌بندی خودکار","Automatic Scheduler","Автопланировщик"],"بازه Backup (ساعت)":["بازه Backup (ساعت)","Backup interval (hours)","Интервал бэкапа (часы)"],"شامل PG-Node شود":["شامل PG-Node شود","Include PG-Node","Включить PG-Node"],"ذخیره و شروع":["ذخیره و شروع","Save & Start","Сохранить и запустить"],"توقف":["توقف","Stop","Остановить"],"همین حالا یک Backup کامل بگیرید.":["همین حالا یک Backup کامل بگیرید.","Create a full backup now.","Создать полный бэкап сейчас."],"یک پیام آزمایشی با تنظیمات فعلی ارسال می‌شود.":["یک پیام آزمایشی با تنظیمات فعلی ارسال می‌شود.","A test message will be sent using the current settings.","Будет отправлено тестовое сообщение с текущими настройками."],"پیام تست با موفقیت ارسال شد.":["پیام تست با موفقیت ارسال شد.","Test message sent successfully.","Тестовое сообщение отправлено."],"ارسال پیام تست ناموفق بود.":["ارسال پیام تست ناموفق بود.","Test message failed.","Не удалось отправить тестовое сообщение."],"تنظیمات عمومی ذخیره شد.":["تنظیمات عمومی ذخیره شد.","General settings saved.","Общие настройки сохранены."],"تنظیمات Telegram با موفقیت ذخیره شد.":["تنظیمات Telegram با موفقیت ذخیره شد.","Telegram settings saved successfully.","Настройки Telegram сохранены."],"تنظیمات حساب با موفقیت ذخیره شد.":["تنظیمات حساب با موفقیت ذخیره شد.","Account settings saved successfully.","Настройки аккаунта сохранены."],"تنظیمات با موفقیت ذخیره شد و روی کل وب‌پنل اعمال شد.":["تنظیمات با موفقیت ذخیره شد و روی کل وب‌پنل اعمال شد.","Settings saved and applied across the web panel.","Настройки сохранены и применены ко всей панели."],"Scheduler ذخیره و شروع شد.":["Scheduler ذخیره و شروع شد.","Scheduler saved and started.","Планировщик сохранён и запущен."],"Scheduler ذخیره شد ولی شروع آن با خطا مواجه شد.":["Scheduler ذخیره شد ولی شروع آن با خطا مواجه شد.","Scheduler saved, but starting it failed.","Планировщик сохранён, но запуск завершился ошибкой."],"Scheduler متوقف شد":["Scheduler متوقف شد","Scheduler stopped","Планировщик остановлен"],
"Backup هفت روز اخیر":["Backup هفت روز اخیر","Backup — Last 7 Days","Бэкапы за 7 дней"],"Backup Activity":["Backup Activity","Backup Activity","Активность бэкапов"],"فضای دیسک":["فضای دیسک","Disk Space","Дисковое пространство"],"Disk Monitor":["Disk Monitor","Disk Monitor","Мониторинг диска"],"وضعیت سرویس‌ها":["وضعیت سرویس‌ها","Service status","Состояние сервисов"],"Health Check":["Health Check","Health Check","Проверка состояния"],"منابع سرور مجازی":["منابع سرور مجازی","Virtual Server Resources","Ресурсы виртуального сервера"],"CPU · RAM · Disk · پایش لحظه‌ای":["CPU · RAM · Disk · پایش لحظه‌ای","CPU · RAM · Disk · Live monitoring","CPU · RAM · Disk · Мониторинг в реальном времени"],"نمودار لحظه‌ای منابع سرور":["نمودار لحظه‌ای منابع سرور","Live server resource chart","График ресурсов сервера в реальном времени"],"وضعیت لحظه‌ای سرور":["وضعیت لحظه‌ای سرور","Live server status","Состояние сервера в реальном времени"],"LIVE TELEMETRY":["LIVE TELEMETRY","LIVE TELEMETRY","МОНИТОРИНГ В РЕАЛЬНОМ ВРЕМЕНИ"],"فعالیت‌های اخیر":["فعالیت‌های اخیر","Recent Activity","Последние действия"],"آخرین فعالیت‌ها":["آخرین فعالیت‌ها","Recent Activity","Последние действия"],"تعداد فعالیت‌های اخیر":["تعداد فعالیت‌های اخیر","Recent activity count","Количество последних действий"],"همین الان":["همین الان","Just now","Только что"],"دقیقه پیش":["دقیقه پیش","minutes ago","мин. назад"],"ساعت پیش":["ساعت پیش","hours ago","ч. назад"],"روز پیش":["روز پیش","days ago","дн. назад"],"دقیقه":["دقیقه","minutes","мин."],"ساعت":["ساعت","hours","ч."],"روز":["روز","days","дн."],"به‌روزرسانی":["به‌روزرسانی","Updated","Обновлено"],"اکنون":["اکنون","Now","Сейчас"],
...
const LANG_INDEX={fa:0,en:1,ru:2};
function translate(raw,lang){
  if(!raw)return raw;
  const idx=Object.prototype.hasOwnProperty.call(LANG_INDEX,lang)?LANG_INDEX[lang]:LANG_INDEX.en;
  const exact=ALIAS[raw.trim()];
  if(exact)return exact[idx] ?? raw;
  let out=raw;
  for(const k of keys){
    if(out.includes(k)){
      const translated=ALIAS[k][idx];
      if(translated) out=out.split(k).join(translated);
    }
  }
  return out;
}
...
</main><script>__LANG_SCRIPT__</script></body></html>""" % (
...
)).replace("__LANG_MENU__", ui_language_menu()).replace("__LANG_SCRIPT__", ui_language_script())
